...
resource "citrixadc_sslcipher" "ssl_cg_goeuc_fe_TLS1213" {
    ...
    depends_on = [
        citrixadc_sslparameter.enable_default
    ]
}
...
resource "citrixadc_sslprofile" "ssl_prof_goeuc_fe_1213" {
    ...
    cipherbindings {
        ciphername     = "ssl_cg_goeuc_fe_TLS1213"
        cipherpriority = 10
    }
...
resource "citrixadc_sslprofile" "ssl_prof_goeuc_fe_13" {
    ...
    cipherbindings {
        ciphername     = "ssl_cg_goeuc_fe_TLS13"
        cipherpriority = 10
    }
    ...
    depends_on = [
        citrixadc_sslcipher.ssl_cg_goeuc_fe_TLS13
    ]
}
...
resource "citrixadc_sslprofile" "ssl_prof_goeuc_be_12" {
    ...
    cipherbindings {
        ciphername     = "ssl_cg_goeuc_be_TLS12"
        cipherpriority = 10
    }
...
resource "citrixadc_nsconfig_save" "ns_save_ssl" {    
    ...
    depends_on = [
        ...
        citrixadc_sslcipher.ssl_cg_goeuc_fe_TLS13,
        citrixadc_sslcipher.ssl_cg_goeuc_be_TLS12,
        citrixadc_sslprofile.ssl_prof_goeuc_fe_1213,
