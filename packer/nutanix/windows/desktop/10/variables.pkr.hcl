/*
    DESCRIPTION:
    Microsoft Windows 10 variables using the Packer Builder for Nutanix (Prism Central).
*/
...
variable "iso_uri" {
  type        = string
  description = "The URI of the guest operating system ISO. Downloaded into the Prism image library on first use. (e.g. 'http://10.0.0.6:8080/Microsoft/windows_10.iso')"
}
...
variable "virtio_driver_path" {
  type        = string
  description = "The driver folder on the VirtIO ISO for this operating system. (e.g. 'E:\\Windows 10\\x64')"
  default     = "E:\\Windows 10\\x64"
}
