/*
    DESCRIPTION:
    Microsoft Windows Server 2025 variables using the Packer Builder for Nutanix (Prism Central).
*/
...
variable "vm_guest_os_version" {
  type        = string
  description = "The guest operating system version. Used for naming. (e.g. '2025')"
  default     = "2025"
}
...
variable "virtio_driver_path" {
  type        = string
  description = "The driver folder on the VirtIO ISO for this operating system. (e.g. 'E:\\Windows Server 2022\\x64')"
  default     = "E:\\Windows Server 2022\\x64"
}
