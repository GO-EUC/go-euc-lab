...
source "azure-arm" "windows" {
  ...
  build_resource_group_name              = "rg-golab-${local.environment_abbreviations[var.environment]}-cvads"
  ...
  managed_image_resource_group_name      = "rg-golab-${local.environment_abbreviations[var.environment]}-cvads"
